...
class FastSHAP:
    ...
    def train(self,
        ...
        # PARCHE DE COMPATIBILIDAD (no altera la lógica del paper):
        # PyTorch >= 2.x eliminó el parámetro 'verbose' de
        # ReduceLROnPlateau. Se omite aquí; no afecta el comportamiento
        # del scheduler, solo su logging interno opcional.
